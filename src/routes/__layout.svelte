...
<div class="container">
      ...
      <header class="tstbite-header bg-white">
        <nav class="navbar navbar-expand-lg has-header-inner px-0">
          ...
          <div class="tstbite-header-links d-flex align-items-center ms-auto order-0 order-lg-2">
            ...
            <a href="#0" class="ms-4 ms-md-4 me-2 me-md-0 circle"><img src="assets/images/avatars/avatar1.png" alt="Avatar"></a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="menu-4">
            <ul class="navbar-nav m-auto pt-3 pt-lg-0">
              <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" id="HomePage" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span>Home Page</span>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" id="RecipePage" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" id="Pages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span>Pages</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="9.333" height="5.333" viewBox="0 0 9.333 5.333">
                    <path d="M1.138.2A.667.667,0,0,0,.2,1.138l4,4a.667.667,0,0,0,.943,0l4-4A.667.667,0,1,0,8.2.2L4.667,3.724Z"/>
                  </svg>
      ...
      <div class="tstbite-search">
        <div class="container">
          ...
          <div class="search-results" id="SearchList">
            ...
            <div class="tstbite-search-list">
              <a href="#0">
                <figure><img src="assets/images/menus/menu112.jpg" class="rounded-2" alt="Menu"></figure>
                <div class="tstbite-search-name">
            ...
            <div class="tstbite-search-list">
              <a href="#0">
                <figure><img src="assets/images/menus/menu113.jpg" class="rounded-2" alt="Menu"></figure>
                <div class="tstbite-search-name">
            ...
            <div class="tstbite-search-list">
              <a href="#0">
                <figure><img src="assets/images/menus/menu114.jpg" class="rounded-2" alt="Menu"></figure>
                <div class="tstbite-search-name">
            ...
            <div class="tstbite-search-list">
              <a href="#0">
                <figure><img src="assets/images/menus/menu115.jpg" class="rounded-2" alt="Menu"></figure>
                <div class="tstbite-search-name">
            ...
            <div class="tstbite-search-list">
              <a href="#0">
                <figure><img src="assets/images/menus/menu116.jpg" class="rounded-2" alt="Menu"></figure>
                <div class="tstbite-search-name">
