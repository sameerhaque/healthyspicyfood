...
<section class="tstbite-section p-0">
          ...
          <div class="col-lg-5">
            <div class="p-4 p-md-5 d-flex flex-column justify-content-center h-100 position-relative">
              <strong>
                ...
                <span class="ms-2 caption font-weight-medium">85% would make this again</span>
              </strong>
      ...
      <section class="tstbite-components my-4 my-md-5">
        ...
        <div class="row">
          <div class="col-md-4">
            <figure class="my-3 tstbite-card">
              <a href="#0" class="tstbite-animation rounded-6">
                <img src="assets/images/menus/menu2.jpg" class="w-100" alt="Menu">
              </a>
          ...
          <div class="col-md-4">
            <figure class="my-3 tstbite-card">
              <a href="#0" class="tstbite-animation rounded-6">
                <img src="assets/images/menus/menu3.jpg" class="w-100" alt="Menu">
              </a>
              <figcaption class="mt-2">
                <div class="w-100 float-start">
                  <div class="float-start">
                ...
                <a href="#0" class="f-size-20 text-black d-block mt-1 font-weight-semibold">Fancy Glazed Dounts</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-md-4">
            <figure class="my-3 tstbite-card">
              <a href="#0" class="tstbite-animation rounded-6">
                <img src="assets/images/menus/menu4.jpg" class="w-100" alt="Menu">
              </a>
              <figcaption class="mt-2">
                <div class="w-100 float-start">
                  <div class="float-start">
                ...
                <a href="#0" class="f-size-20 text-black d-block mt-1 font-weight-semibold">Mighty Cheesy Breakfast Burger</a>
              </figcaption>
            </figure>
          </div>
        </div>
      ...
      <section class="tstbite-components my-4 my-md-5">
        ...
        <div class="row">
          <div class="col-md-4">
            <figure class="my-3 tstbite-card">
              <a href="#0" class="tstbite-animation rounded-6">
                <img src="assets/images/menus/menu5.jpg" class="w-100" alt="Menu">
              </a>
              <figcaption class="mt-2">
                <div class="w-100 float-start">
                  <div class="float-start">
          ...
          <div class="col-md-4">
            <figure class="my-3 tstbite-card">
              <a href="#0" class="tstbite-animation rounded-6">
                <img src="assets/images/menus/menu6.jpg" class="w-100" alt="Menu">
              </a>
              <figcaption class="mt-2">
                <div class="w-100 float-start">
                  <div class="float-start">
                ...
                <a href="#0" class="f-size-20 text-black d-block mt-1 font-weight-semibold">Chocolate and Banana Jar Cake</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-md-4">
            <figure class="my-3 tstbite-card">
              <a href="#0" class="tstbite-animation rounded-6">
                <img src="assets/images/menus/menu7.jpg" class="w-100" alt="Menu">
              </a>
              <figcaption class="mt-2">
                <div class="w-100 float-start">
                  <div class="float-start">
                ...
                <a href="#0" class="f-size-20 text-black d-block mt-1 font-weight-semibold">Berry Maddness Biscuts</a>
              </figcaption>
            </figure>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <figure class="my-3 tstbite-card">
              ...
              <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-end">
                  <h5 class="mb-3 md-lg-0 pe-0 pe-lg-4 text-start"><a href="#0" class="stretched-link">Sushi Combos for your Next Party</a></h5>
          ...
          <div class="col-md-6">
            <figure class="my-3 tstbite-card">
              ...
              <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-end">
                  <h5 class="mb-3 md-lg-0 pe-0 pe-lg-4 text-start"><a href="#0">Everything Bagel</a></h5>
                  <span class="btn btn-sm btn-outline-dark text-nowrap">156 Recipes</span>
                </div>
              </figcaption>
            </figure>
          ...
          <div class="col-md-6">
            <figure class="my-3 tstbite-card">
              ...
              <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-end">
                  <h5 class="mb-3 md-lg-0 pe-0 pe-lg-4 text-start"><a href="#0">Cook Like a Chef</a></h5>
                  <span class="btn btn-sm btn-outline-dark text-nowrap">156 Recipes</span>
                </div>
              </figcaption>
            </figure>
          ...
          <div class="col-md-6">
            <figure class="my-3 tstbite-card">
              ...
              <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-end">
                  <h5 class="mb-3 md-lg-0 pe-0 pe-lg-4 text-start"><a href="#0">Exquisite Dinner Recipe Ideas</a></h5>
                  <span class="btn btn-sm btn-outline-dark text-nowrap">156 Recipes</span>
                </div>
              </figcaption>
            </figure>
          ...
          <div class="col-md-6">
            <figure class="my-3 tstbite-card">
              ...
              <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-end">
                  <h5 class="mb-3 md-lg-0 pe-0 pe-lg-4 text-start"><a href="#0">The Ultimate Cookie Frenzy</a></h5>
                  <span class="btn btn-sm btn-outline-dark text-nowrap">156 Recipes</span>
                </div>
              </figcaption>
            </figure>
          ...
          <div class="col-md-6">
            <figure class="my-3 tstbite-card">
              ...
              <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-end">
                  <h5 class="mb-3 md-lg-0 pe-0 pe-lg-4 text-start"><a href="#0">For the Love of Donuts</a></h5>
                  <span class="btn btn-sm btn-outline-dark text-nowrap">156 Recipes</span>
                </div>
              </figcaption>
            </figure>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Cashew Vegan Rice</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Smoked Salmon Salad Sandwich</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Salmon in Creamy Sun Dried Tomato Sauce</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Healthy Jam Waffle Breakfast</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Chocolate and Banana Jar Cake</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Caramel Blueberry Scones</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Blueberry Carrot Cake</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Vegan Cauliflower Salad</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Roasted Red Pepper Soup</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Eggs and Avocado Toast</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Pork Shoulder Cashew Noodles</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Toasted Farfalle In Pesto Sauce</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Cheesy Bacon Burger Sliders</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Fig and Raisins Oatmeal</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Silky Smooth Panacotta</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Triple Decker Cranberry Cake</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Very Berry Healthy Summer Smoothie</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Crispy Orange Chips</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Tumeric Lavendar Tea</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Blue Velvet Brownies</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Birthday Cupcakes</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Gourmet Fillet in Roasted Almond Sauce</a>
              </figcaption>
            </figure>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <figure class="my-3 my-md-4 tstbite-card">
              ...
              <figcaption class="mt-2">
                <a href="recipe-sidebar.html" class="text-black d-block mt-1 font-weight-semibold big">Four Ingredient Oatmeal Pancakes</a>
              </figcaption>
            </figure>
          </div>
        </div>
    ...
    <!-- Tstbite Footer, Pt 3, Pt Md 5, Mt 5 -->
        ...
        <div class="row pt-4 pb-0 pb-md-5">
          <div class="col-md-6">
            <div class="tastebite-footer-contnet pe-0 pe-lg-5 me-0 me-md-5">
              ...
              <p class="mt-3 text-gray-300 pe-0 pe-lg-5 me-0 me-lg-4">"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment</p>
            </div>
          </div>
          <div class="col-md-2">
      ...
      <div class="container">
        ...
        <div class="row pb-4 pt-2 align-items-center">
          <div class="col-md-6 order-2 order-md-0">
            <p class="text-gray-300 small text-start mb-0">&copy; 2020 Tastebite - All rights reserved</p>
          </div>
          <div class="col-md-6">
